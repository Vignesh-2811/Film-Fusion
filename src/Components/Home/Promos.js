      ...
      <div className='lg:grid lg:grid-cols-2 lg:gap-10 items-center'>
        <div className='flex lg:gap-10 gap-6 flex-col'>
          ...
          <p className='text-text text-sm xl:text-base leading-6 xl:leading:8'>
            ...
            Praesentium, alias. Lorem ipsum dolor sit amet consectetur
            adipisicing elit. Praesentium, alias. Lorem ipsum dolor sit amet
            consectetur adipisicing elit. Praesentium, alias. Lorem ipsum dolor
            sit amet consectetur adipisicing elit. Praesentium, alias. Lorem
