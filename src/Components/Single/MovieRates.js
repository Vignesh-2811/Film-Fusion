      ...
      <div className='mt-10 xl:grid flex-colo grid-cols-5 gap-12 bg-dry xs:p-10 py-10 px-2 sm:p-20 rounded'>
        <div className='xs:col-span-2 w-full flex flex-col gap-8'>
          ...
          <p className='text-sm leading-7 font-medium text-border'>
            ...
            ipsum dol or, sit amet consectetur adipisicing elit.
          </p>
        ...
        <div className='col-span-3 flex flex-col gap-6'>
          ...
          <div className='w-full flex flex-col bg-main gap-6 rounded-lg md:p-12 p-6 h-header'>
            {UsersData.map((user, i) => {
              <div className='md:grid flex flex-col w-full grid-cols gap-6 bg-dry p-4 border border-gray-800 rounded-lg'>
                <div className='col-span-2 bg-main hidden md:block'>
                  <img
                    src={require(`/src/images/${user?.image}`)}
                    alt={user.name}
                ...
                <div className='col-span 3 flex-rows border-l border-border text-xs gap-1 text-sm'>
